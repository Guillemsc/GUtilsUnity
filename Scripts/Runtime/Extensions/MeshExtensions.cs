...
namespace GUtilsUnity.Extensions
{
    ...
    {
        /// <summary>
        /// Calls <see cref="BoundsExtensions.GetPivot"/> on the mesh <see cref="Mesh.bounds"/>.
        /// </summary>
        public static Vector3 GetPivot(this Mesh mesh) => mesh.bounds.GetPivot();
        ...
        public static List<List<Vector3>> GetContourVerticesOfMesh(this Mesh mesh)
        {
            ...
            {
                lookup.TryAdd(edge.Key, edge.Value);
            }
