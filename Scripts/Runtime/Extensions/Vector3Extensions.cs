...
namespace GUtilsUnity.Extensions
{
    public static class Vector3Extensions
    {
        ...
        /// <summary>
        /// Converts a <see cref="Vector3"/> object to a <see cref="Vector3Int"/> object, rounding down
        /// each component to the nearest integer.
        /// </summary>
        /// <param name="vector">The input <see cref="Vector3"/> object.</param>
        /// <returns>A new <see cref="Vector3Int"/> object with each component rounded down to the nearest integer.</returns>
        public static Vector3Int ToVector3Int(this Vector3 vector)
            => new((int)vector.x, (int)vector.y, (int)vector.z);

        /// <summary>
        /// Converts a <see cref="Vector3"/> object to a <see cref="Vector3Int"/> object, rounding each component to the nearest integer.
        /// </summary>
        /// <param name="value">The input <see cref="Vector3"/> object.</param>
        /// <returns>A new <see cref="Vector3Int"/> object with each component rounded to the nearest integer.</returns>
        public static Vector3Int ToVector3IntRounded(this Vector3 value)
