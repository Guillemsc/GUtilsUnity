...
{
    public static class OneOfTwoExtensions
    {
        /// <summary>
        ...
        )
        {
            ...
            TSecond second = oneOf.GetSecondUnsafe();
        ...
        public static Optional<TFirst> GetFirstOptional<TFirst, TSecond>(this IOneOf<TFirst, TSecond> oneOf)
        {
            if(!oneOf.TryGetFirst(out TFirst first))
            {
        ...
        public static Optional<TSecond> GetSecondOptional<TFirst, TSecond>(this IOneOf<TFirst, TSecond> oneOf)
        {
