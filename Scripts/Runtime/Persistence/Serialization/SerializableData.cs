...
using GUtilsUnity.Persistence.Constants;
using GUtilsUnity.Persistence.Migrations;
    ...
    public sealed class SerializableData<T> : ISerializableData<T> where T : class
    {
        ...
        public async Task Load(CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    string dataString = optionalLoadedData.GetFirstUnsafe();
        ...
        {
            return PopcoreCoreApplication.IsDebug ? PersistenceConstants.DebugJsonSettings : PersistenceConstants.ReleaseJsonSettings;
        }
    }
}
