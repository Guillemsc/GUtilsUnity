...
namespace GUtilsUnity.SafeArea.Extensions
{
    public static class ScreenSafeAreaConfigurationExtensions
    {
        /// <summary>
        ...
        /// </summary>
        public static int GetReferenceOrientationStepsDifference(this ScreenSafeAreaConfiguration settings, ScreenOrientation orientation)
        {
