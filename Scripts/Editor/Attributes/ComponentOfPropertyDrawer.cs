...
{
    [CustomPropertyDrawer(typeof(ComponentOfAttribute))]
    public class ComponentOfPropertyDrawer : PropertyDrawer
    {
            ...
            SerializedProperty property)
        {
            ...
            UnityEngine.Object GetObject()
            {
                ...
                {
                    Component component => component.GetComponent(fieldInfo.FieldType),
                    GameObject gameObject => gameObject.GetComponent(fieldInfo.FieldType),
